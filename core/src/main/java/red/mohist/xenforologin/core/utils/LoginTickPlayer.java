...
public class LoginTickPlayer {
    ...
    static final int showTipTime = XenforoLogin.instance.config.getInt("secure.show_tips_time", 5);
    long startTime = System.currentTimeMillis();
    int loginTimeout = XenforoLogin.instance.config.getInt("secure.max_login_time", 30);
    @Nonnull
    Player player;
