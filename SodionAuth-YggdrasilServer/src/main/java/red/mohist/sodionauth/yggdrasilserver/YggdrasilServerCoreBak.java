...
public class YggdrasilServerCoreBak {
    public static YggdrasilServerCoreBak instance;
    private final int port;
    public RSAPublicKey rsaPublicKey;
    public RSAPrivateKey rsaPrivateKey;
    public KeyPair rsaKeyPair;

    public YggdrasilServerCoreBak() throws NoSuchAlgorithmException, SQLException {
