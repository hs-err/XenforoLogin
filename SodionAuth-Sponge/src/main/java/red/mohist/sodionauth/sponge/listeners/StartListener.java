...
import org.spongepowered.api.event.item.inventory.UseItemStackEvent.Start;
...
public class StartListener implements SpongeAPIListener {
    @Listener(order = Order.FIRST, beforeModifications = true)
    public void onStartEvent(Start event, @First Player player) {
