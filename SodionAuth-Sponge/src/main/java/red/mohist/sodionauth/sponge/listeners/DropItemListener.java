...
public class DropItemListener implements SpongeAPIListener {
    @Listener(order = Order.FIRST, beforeModifications = true)
    public void onDropItemEvent(DropItemEvent event, @First Player player) {
